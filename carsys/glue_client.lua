local specialVeh = { [500]=true, [422]=true, [478]=true, [455]=true, [600]=true, [554]=true, [543]=true }
...
function glue()
	...
	if not getPedOccupiedVehicle(player) then
		...
		if getElementType(vehicle) == "vehicle" then
			if raftboots[getElementModel(vehicle)] or boote[getElementModel(vehicle)] or specialVeh[getElementModel(vehicle)] then
