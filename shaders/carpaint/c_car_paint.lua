...
addEventHandler( "onClientResourceStart", resourceRoot,
	function()
		...
		-- Create shader
		local myShader, tec = dxCreateShader ( "shaders/carpaint/car_paint.fx" )
		...
		if not myShader then
			...
			-- Set textures
			local textureVol = dxCreateTexture ( "shaders/carpaint/images/smallnoise3d.dds" );
			local textureCube = dxCreateTexture ( "shaders/carpaint/images/cube_env256.dds" );
