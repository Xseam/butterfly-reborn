...
function enableContrast()
	...
	-- Shaders
	contrastShader = dxCreateShader( "shaders/contrast/fx/contrast.fx" )
	bloomCombineShader = dxCreateShader( "shaders/contrast/fx/bloom_combine.fx" )
	bloomExtractShader = dxCreateShader( "shaders/contrast/fx/bloom_extract.fx" )
	blurHShader = dxCreateShader( "shaders/contrast/fx/blurH.fx" )
	blurVShader = dxCreateShader( "shaders/contrast/fx/blurV.fx" )
	modulationShader = dxCreateShader( "shaders/contrast/fx/modulation.fx" )
	...
	-- Overlay texture
	textureVignette = dxCreateTexture ( "shaders/contrast/images/vignette1.dds" );
...
addEventHandler( "onClientHUDRender", root,
    function()
		if(bEffectEnabled == false) then return end
