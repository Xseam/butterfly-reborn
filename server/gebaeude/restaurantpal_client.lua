local Ped = createPed(93, 2329.197265625, 8.1397333145142, 26.522361755371)
setPedRotation(Ped, 180)
addEventHandler("onClientPedDamge", Ped, cancelEvent)
 
local Marker = createMarker(2329.2768554688, 6.7813024520874, 26.021799087524, "cylinder", 1.0, 255, 0, 0, 200)
local Guivar = 0
...
showCursor(true)
	...
	Saufenlabel[1] = guiCreateLabel(10,27,256,19,"Willkommen! Was darf's sein?",false,Saufenfenster[1])
